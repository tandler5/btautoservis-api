...
class OsRolesHelper
{
    ...
    {
        return OsSettingsHelper::save_setting_by_name('agent_role_capabilities', json_encode($capabilities));
    }
    ...
    public static function save_from_params(array $role_params)
    {
        ...
        switch ($role->user_type) {
            ...
            case LATEPOINT_USER_TYPE_CUSTOM:
                ...
                if (OsSettingsHelper::save_setting_by_name('custom_roles', json_encode($roles))) {
    ...
    {
        return \OsSettingsHelper::save_setting_by_name('custom_roles', json_encode($roles));
    }
    ...
    public static function name_for_action($action_code)
    {
        $action_names = [
            ...
            'booking' => __('Bookings', 'latepoint'),
            'customer' => __('Customers', 'latepoint'),
            'transaction' => __('Transactions', 'latepoint'),
