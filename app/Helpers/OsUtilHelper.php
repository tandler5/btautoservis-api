...
class OsUtilHelper {
  ...
  public static function template_variables_link_html(){
    return '<a href="#" class="field-note-info-link open-template-variables-panel"><i class="latepoint-icon latepoint-icon-info"></i><span>'.__('Show Available Variables', 'latepoint').'</span></a>';
  }
  ...
  public static function verify_nonce($nonce, $string = ''){
	...
	public static function pro_feature_block($label_override = false) {
		$label = $label_override ? $label_override : __('Install PRO Addon to enable this feature', 'latepoint');
		return '<a href="'.OsRouterHelper::build_link(['addons', 'index']).'" class="os-add-box" >
